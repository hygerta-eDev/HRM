      ...
      <div v-if="Training" class="edit-Training p-8 rounded-lg shadow-xl border border-blue-200 bg-gray-100">
        ...
        <div class="Training-details flex flex-wrap">
          ...
          <div class="w-full md:w-1/2 mb-4 px-2">
            ...
            <input v-model="Training.start_date" type="date" class="w-full px-3 py-2 border border-blue-200 rounded-md shadow-md">
          </div>
          <div class="w-full md:w-1/2 mb-4 px-2">
            <label class="block text-gray-700 text-sm font-bold mb-2">End Date</label>
            <input v-model="Training.end_date" type="date" class="w-full px-3 py-2 border border-blue-200 rounded-md shadow-md">
          </div>
          ...
          <div class="w-full md:w-1/2 mb-4 px-2">
            ...
            <div class="flex items-center mt-3 ml-48">
              <InputSwitch v-model="Training.active" />
            </div>
          </div>
